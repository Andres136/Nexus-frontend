...
export const indicadoresApi = {
  ...
  getIndicadoresDepartamento: (params) =>
    apiClient.get("/api/indicadoresAdmin", { params }),
};
...
export const valoresIndicadoresApi = {
  ...
  create: (data) =>
    apiClient.post("/api/registro-indicadores", data, {
...
export const indicadoresDepartamentoApi = {
  getAll: (params, page) =>
    apiClient.get("/api/rendimiento-indicadores", {
      params: { ...params, page },
    }),
};
...
export const empresaApi = {
  ...
  create: (data) =>
    apiClient.post("/api/empresas", data, {
      headers: { "Content-Type": "multipart/form-data" },
    }),
...
export const productsApi = {
  ...
  registrarEntradaMasiva: (data) =>
    apiClient.post("/api/products/importar-excel", data, {
      headers: { "Content-Type": "multipart/form-data" },
    }),
...
export const ordenesCompraProveedoresApi = {
  ...
  getPdf: (id) =>
    apiClient.get(`/api/orden-compras-proveedor/${id}/pdf`, {
...
export const documentacionApi = {
  getAll: (params = {}) =>
    apiClient.get("/api/registrar-documentacion", { params }),
  getById: (id) => apiClient.get(`/api/registrar-documentacion/${id}`),
  create: (data) =>
    apiClient.post("/api/registrar-documentacion", data, {
      headers: { "Content-Type": "multipart/form-data" },
    }),
  update: (id, data) =>
    apiClient.put(`/api/registrar-documentacion/${id}`, data, {
      headers: { "Content-Type": "multipart/form-data" },
    }),
  delete: (id) => apiClient.delete(`/api/registrar-documentacion/${id}`),
  moverAObseletos: (id) =>
    apiClient.post(`/api/documentos/mover-obseletos/${id}`),
};
...
export const plantillasApi = {
  ...
  create: (data) =>
    apiClient.post("/api/plantillas-correo", data, {
      headers: { "Content-Type": "multipart/form-data" },
    }),
  update: (id, data) => {
    if (data instanceof FormData) {
  ...
  enviarEmail: (id, data) =>
    apiClient.post(`/api/plantillas/${id}/enviar`, data),

  getForEdit: (id) => apiClient.get(`/api/plantillas/${id}/edit`),
};

//Api para gestionar los eventos de entrega
export const deliveryEventsApi = {
  getAll: (params = {}) => apiClient.get("/api/eventos-entrega", { params }),
  getById: (id) => apiClient.get(`/api/eventos-entrega/${id}`),
  create: (data) => apiClient.post("/api/eventos-entrega", data),
  update: (id, data) => apiClient.put(`/api/eventos-entrega/${id}`, data),
  delete: (id) => apiClient.delete(`/api/eventos-entrega/${id}`),
  getOrdenesTrabajoParaEntregas: (params = {}) => apiClient.get("/api/ordenes-trabajo-entregas", { params }),
