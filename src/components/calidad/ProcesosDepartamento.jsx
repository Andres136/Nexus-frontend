    ...
    <div className="p-6 bg-gray-50 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
        ...
        <div className="bg-white p-4 rounded-lg shadow-md">
          <h3 className="text-xl font-semibold mb-4 text-gray-800">Items Registrados</h3>
          {procesos.length > 0 ? (
        ...
        <div className="bg-white p-6 rounded-lg shadow-md ">
          <h3 className="text-xl font-semibold mb-4 text-gray-800">
            Documentación de: {procesoActual?.nombre || 'No hay procesos'}
          </h3>
          ...
          <div className="bg-white p-4 rounded-lg shadow-md">
            <div>
              ...
              <div className="mt-6">
                ...
                >
                  Registrar Documentación para: {procesoActual?.nombre || <span className='text-white'>no se ha seleccionado un item</span>}
                </button>
