...
import { useRegisterTipoRegistro } from "../../hooks/nomina/useRegisterTipoRegistro";

export default function RegisterTipoRegistro({ uuid = null, onClose }) {
  const { formData, handleChange, handleSubmit, fieldErrors, loading, isLoadingData } =
    useRegisterTipoRegistro({ uuid, onSuccess: onClose });
    ...
    <div>
      <div className="mb-6">
        <h2 className="text-lg font-semibold text-gray-800">
          {isEdit ? "Editar Tipo de Registro" : "Nuevo Tipo de Registro"}
        </h2>
        <p className="text-sm text-gray-500 mt-1">
          {isEdit
            ? "Modifica el tipo de registro."
            : "Complete los campos para crear un nuevo tipo de registro."}
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} noValidate className="space-y-5">
        ...
        <div>
          ...
          <input
            ...
            maxLength={45}
            placeholder="Ej: Entrada, Salida, Descanso"
...
RegisterTipoRegistro.propTypes = {
