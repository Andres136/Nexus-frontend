...
{/*Fin de Rutas para control de calidad */}
         ...
         <Route path="/auth/tic/tickets" element={<DynamicProtectedRoute permission="/auth/tic/tickets">
           <Tickets />
         </DynamicProtectedRoute>} />

         <Route path="/auth/tic/paradas" element={<DynamicProtectedRoute permission="/auth/tic/paradas">
           <ParadasEquipos />
         </DynamicProtectedRoute>} />
