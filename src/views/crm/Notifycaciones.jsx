...
const classBasename = (fullType) =>
  ...
  const { data = { ordenes_compra: [], tareas: [], ingresos:[], total_no_leidas: 0 }, isLoading, error, refetch } = useQuery({
  ...
  return (  <div className="max-w-5xl mx-auto p-6 bg-white rounded shadow">
...
>
  ✔ Marcar todas como leídas
      ...
      {isLoading ? (
        ...
        <p className="text-red-500">Ocurrió un error al cargar las notificaciones.</p>
              ...
              {grupo.map((noti) => (
                ...
                >
                  <div className="text-sm text-gray-700">
                    {noti.data?.mensaje || noti.data?.descripcion || "Sin mensaje"}
                  </div>
