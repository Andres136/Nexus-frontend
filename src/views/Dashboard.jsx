...
const Dashboard = () => {
  ...
  return (
    ...
    <div className="bg-white p-4 rounded shadow">
      <h3 className="font-semibold mb-2">Flujo de estados</h3>
      <ApexChart
        type="bar"
        height={300}
        series={[
    ...
    {/* Por cliente */}
    <div className="bg-white p-4 rounded shadow">
      <h3 className="font-semibold mb-2">Distribución por cliente</h3>
      <ApexChart
        type="pie"
        height={300}
    ...
    {/* Por usuario */}
    <div className="bg-white p-4 rounded shadow">
      <h3 className="font-semibold mb-2">Órdenes por usuario</h3>
      <ApexChart
        type="bar"
        height={300}
        series={[
